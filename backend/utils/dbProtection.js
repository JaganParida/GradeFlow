/**
 * GradeFlow Database Protection & Async Concurrency Semaphore
 * - Limits concurrent active MongoDB queries to prevent M0 connection exhaustion
 * - Bounded memory queue with timeout and overflow protection (never unbounded!)
 */
...
// Global shared database queue for this process
const globalDbQueue = new AsyncDatabaseQueue();
