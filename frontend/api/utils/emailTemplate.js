 ...
 * - ZERO attachments (no CID, no inline images) ΓÇö eliminates Gmail spam scoring
        ...
        <table width="100%" cellspacing="0" cellpadding="0" border="0" style="max-width:560px;background:#ffffff;border-radius:8px;overflow:hidden;border:1px solid #e2e8f0;">
          ...
          <tr>
            <td style="padding:22px 20px;font-size:14px;line-height:1.6;color:#334155;">
              ...
              <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;margin-bottom:16px;">
                <tr>
                  <td style="padding:10px 14px;text-align:center;">
                    <div style="color:#64748b;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:2px;">Backlog Status</div>
                    <div style="color:${numBacklogs > 0 ? '#b91c1c' : '#15803d'};font-size:14px;font-weight:700;">You currently have ${backlogsText}.</div>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;margin-bottom:16px;">
                <tr>
                  <td style="padding:12px;text-align:center;">
                    ...
                    <a href="${studentPortalUrl}" target="_blank" style="display:inline-block;background:#0f172a;color:#ffffff;font-weight:600;font-size:12px;text-decoration:none;padding:7px 16px;border-radius:4px;">
              ...
              <!-- Important Note -->
              <div style="background:#fffbeb;border-left:3px solid #f59e0b;padding:10px 12px;margin-bottom:16px;">
                <div style="font-weight:700;font-size:11px;color:#b45309;margin-bottom:2px;">Important Note</div>
