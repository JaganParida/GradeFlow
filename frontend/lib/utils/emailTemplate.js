...
<body style="font-family: Arial, sans-serif; background-color: #ffffff; color: #333333; line-height: 1.6; margin: 0; padding: 20px;">
  ...
  <div style="margin-bottom: 28px;">
    ...
    <div style="text-align: center; margin-top: 18px; margin-bottom: 28px;">
      <a href="${waUrl}" style="display: inline-block; padding: 12px 20px; background-color: #25D366; color: #ffffff; font-weight: bold; font-size: 14px; text-decoration: none; border-radius: 8px; box-shadow: 0 2px 6px rgba(37,211,102,0.25); white-space: nowrap;">💬 Contact Developer on WhatsApp</a>
    </div>
  </div>
