  ...
  const renderSubjectRow = (sub, idx, isPending = false) => {
    ...
    return (
      ...
      >
        ...
        <div
          className="mobile-flex-row"
          style={{ textAlign: "center", opacity: isPending ? 0.6 : 1 }}
        >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          {data.subjects.length > 0 ? (
            data.subjects.map((sub, idx) =>
              renderSubjectRow(sub, "ex-" + idx, false),
            )
          ) : (
            <div
              style={{
        ...
        >
              ...
              <div style={{ marginBottom: 32 }}>
                ...
                >
                  ...
                  {takenSkillCourses.map((sub, idx) =>
                    renderSubjectRow(sub, "skill-" + idx, false),
                  )}
                </div>
              </div>
            );
          ...
          {inferredDomain ? (
            ...
            <>
              ...
              >
                You have not registered for any specific Domain Track subjects
                yet. Once you do, your syllabus will automatically appear here!
              </p>
              <h4
                style={{
                  fontSize: 14,
          ...
          {b5ExtraSubjects.length > 0 && (
            <>
              ...
              >
                {inferredDomain
                  ? "Additional B5 Subjects"
                  : "Your Completed B5 Subjects"}
              </h4>
              <div
                style={{
                  border: "1px solid var(--border-color)",
          ...
          >
            ...
            >
              ...
              <circle
                ...
                strokeDasharray="226"
                strokeDashoffset={
                  226 - 226 * Math.min(1, totalEarned / targetTotal)
                }
                strokeLinecap="round"
              />
            </svg>
            ...
            >
              {Math.round(Math.min(100, (totalEarned / targetTotal) * 100))}%
            </span>
          </div>
          <div>
            <h3
          ...
          <div>
            <h3
              style={{
                fontSize: 16,
                fontWeight: 700,
                color: isHonoursEligible ? "#f59e0b" : "var(--text-main)",
                marginBottom: 4,
              }}
            >
              B.Tech Honours
            ...
            {isHonoursEligible ? (
              ...
              >
                <span
                  style={{ color: "#f59e0b", fontWeight: 700, fontSize: 16 }}
                >
                  {honoursCredits}
                </span>{" "}
                / {honoursTarget} Extra Domain Credits
              </p>
            )}
          </div>
        </div>
