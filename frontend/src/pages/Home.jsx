...
export default function Home() {
  ...
  const renderQuickActionsCard = (isHeroMobile = false) => (
    <div
      className={
        isHeroMobile
          ? "gf-mobile-quick-card gf-content-card"
          : "gf-desktop-quick-card gf-content-card"
      }
      style={{
        background: "#ffffff",
    ...
    >
      <div
        style={{
          ...
          alignItems: "center",
          justifyContent: "space-between",
          marginBottom: isHeroMobile ? 12 : 16,
        }}
      >
        <h3
          style={{
  ...
  const handleSearchModalSubmit = async (e) => {
    ...
    try {
      ...
      if (success) {
        ...
        if (
          pendingQuickAction &&
          pendingQuickAction.to.startsWith("/analytics")
        ) {
          const query = pendingQuickAction.tab
            ? `?tab=${pendingQuickAction.tab}`
            : "";
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          >
            <GraduationCap size={13} color="#2563eb" /> Centurion University
            Academic Portal
          </span>
        </div>
        ...
        >
          Real-time GPA tracking, university rankings, placement insights, and
          simulation tools.
        </p>
        ...
        {authChecking ? (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div>
                <div
                  style={{ fontSize: 13.5, fontWeight: 800, color: "#166534" }}
                >
          ...
          <div style={{ marginTop: 4 }}>
            ...
            >
              ...
              <span>
                Secured via Centurion University Email OTP &middot; Single
                Active Device
              </span>
            </div>
          </div>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            ...
            <span style={{ fontWeight: 800, color: "#0f172a", marginLeft: 4 }}>
              5.0 Rating
            </span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
            ...
            <span>
              <strong style={{ color: "#0f172a" }}>1000+</strong> students
            </span>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        {mobileShowcaseTab === "tracker" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            >
              ...
              >
                <span
                  style={{ fontSize: 10.5, color: "#1e40af", fontWeight: 700 }}
                >
                  CUMULATIVE CGPA
                </span>
                <div
              ...
              >
                <span
                  style={{ fontSize: 10.5, color: "#065f46", fontWeight: 700 }}
                >
                  LATEST SGPA
                </span>
                <div
            ...
            >
              Track semester-by-semester SGPA progression, total credits earned,
              and historical GPA growth trajectory.
            </p>
            <button
              onClick={() =>
                handleQuickAction({
        ...
        {mobileShowcaseTab === "rankings" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            >
              ...
              >
                <span
                  style={{ fontSize: 10.5, color: "#5b21b6", fontWeight: 700 }}
                >
                  UNIVERSITY RANK
                </span>
                <div
                ...
                <span
                  style={{ fontSize: 10, color: "#6d28d9", fontWeight: 700 }}
                >
                  Top 2% Overall
                </span>
              </div>
              ...
              >
                <span
                  style={{ fontSize: 10.5, color: "#92400e", fontWeight: 700 }}
                >
                  BRANCH RANK
                </span>
                <div
                ...
                <span
                  style={{ fontSize: 10, color: "#b45309", fontWeight: 700 }}
                >
                  CSE Department
                </span>
              </div>
            ...
            >
              Compare your academic standing against classmates across
              semesters, branches (CSE, ME, ECE, CIVIL), and sections.
            </p>
            <button
              onClick={handleLeaderboardAction}
              style={{
        ...
        {mobileShowcaseTab === "career" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            >
              Check placement cutoffs for top recruiters (TCS, Infosys, Wipro,
              Amazon, Deloitte) based on your live CGPA.
            </p>
            <button
              onClick={() =>
                handleQuickAction({
        ...
        {mobileShowcaseTab === "simulator" && (
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            >
              ...
              >
                <span
                  style={{ fontSize: 11, color: "#7e22ce", fontWeight: 700 }}
                >
                  SIMULATED TARGET
                </span>
                <span
                  style={{ fontSize: 11, color: "#16a34a", fontWeight: 800 }}
                >
                  Achievable
                </span>
              </div>
              ...
              >
                Need 8.8 SGPA next semester
              </div>
              <span style={{ fontSize: 10.5, color: "#9333ea" }}>
                To reach 9.00 Cumulative CGPA
              </span>
            </div>
            <p
              style={{
            ...
            >
              Simulate upcoming course grades or compute required SGPA to hit
              your dream graduation honors.
            </p>
            <button
              onClick={() =>
                handleQuickAction({
      ...
      >
        ...
        <div style={{ fontSize: 11, color: "#94a3b8" }}>
          © 2026 GradeFlow. Designed &amp; engineered for Centurion University
          students.
        </div>
      </div>
    </div>
      ...
      {isMobile ? (
            ...
            >
              ...
              >
                ...
                <span style={{ display: "block", whiteSpace: "nowrap" }}>
                  Own Your{" "}
                  <span style={{ color: "#2563eb" }}>Academic Future</span>
                </span>
              </h1>
              ...
              >
                GradeFlow delivers real-time GPA tracking, predictive career
                intelligence, and in-depth performance analytics built for
                academic excellence.
              </p>
          ...
          {!currentRegNo && isMobile && (
            ...
            >
              ...
              >
                ...
                . Log in with your official university email OTP to load your
                personal results and ranking.
              </p>
              <button
                onClick={openStudentAuthModal}
                style={{
        ...
        ══════════════════════════════════════════════════════════ */}
          ...
          >
            ...
            >
              Sample student metrics — Here is how GradeFlow calculates and
              visualizes your CGPA, SGPA, academic health, and university
              standing once searched.
            </p>
          </div>
