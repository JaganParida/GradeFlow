                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                        ...
                        <input
                          ...
                          style={{
                            width: "100%",
                            height: 4,
                            background: `linear-gradient(to right, #2563eb 0%, #2563eb ${Math.max(0, Math.min(100, (Number(healthCgpa) / 10) * 100))}%, #dadce0 ${Math.max(0, Math.min(100, (Number(healthCgpa) / 10) * 100))}%, #dadce0 100%)`,
                            cursor: "pointer",
                            touchAction: "pan-x",
                          }}
                        />
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                        ...
                        <input
                          ...
                          style={{
                            width: "100%",
                            height: 4,
                            background: `linear-gradient(to right, #2563eb 0%, #2563eb ${Math.max(0, Math.min(100, (Number(healthSgpa) / 10) * 100))}%, #dadce0 ${Math.max(0, Math.min(100, (Number(healthSgpa) / 10) * 100))}%, #dadce0 100%)`,
                            cursor: "pointer",
                            touchAction: "pan-x",
                          }}
                        />
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                        ...
                        <input
                          ...
                          style={{
                            width: "100%",
                            height: 4,
                            background: `linear-gradient(to right, #2563eb 0%, #2563eb ${Math.max(0, Math.min(100, (Number(healthBacklogs) / 4) * 100))}%, #dadce0 ${Math.max(0, Math.min(100, (Number(healthBacklogs) / 4) * 100))}%, #dadce0 100%)`,
                            cursor: "pointer",
                            touchAction: "pan-x",
                          }}
                        />
